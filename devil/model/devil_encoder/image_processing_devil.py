...
"""Image processor class for DeViL."""
...
def simple_batched_resize(
    ...
    for image in images:
        ...
        ori_image_sizes.append([height, width])
    ...
    return image_sizes, ori_image_sizes
...
class DeViLImageProcessor(BaseImageProcessor):
    r"""
    ...
    def preprocess(
        ...
        if all(merge_size == merge_sizes[0] for merge_size in merge_sizes):
            target_sizes, ori_sizes = simple_batched_resize(
                images,
