...
from .model.processor import DeViLProcessor
...
from .constants import NUM_FRAMES, DEFAULT_IMAGE_TOKEN, DEFAULT_VIDEO_TOKEN, MODAL_INDEX_MAP, STREAM_START_TOKEN, STREAM_END_TOKEN, DEFAULT_G_DINO_CONFIG_PATH
...
def model_init(model_path=None, max_visual_tokens=None, g_dino_config_path=DEFAULT_G_DINO_CONFIG_PATH, **kwargs):
    model_path = "DAMO-NLP-SG/VideoLLaMA3-7B" if model_path is None else model_path
    model_name = get_model_name_from_path(model_path)
    kwargs.setdefault("g_dino_config_path", g_dino_config_path)
    ...
    processor = DeViLProcessor(image_processor, tokenizer)
