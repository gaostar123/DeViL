...
torchrun --nnodes $WORLD_SIZE \
    ...
    --model_path weights/DeViL_stage1 \
    --vision_encoder weights/VL3-SigLIP-NaViT \
    --mm_projector_type mlp2x_gelu \
    --data_path dataroot/video_annotation_vidstg.json \
    ...
    --tf32 True \
    --fp16 False \
    --output_dir weights/DeViL_stage2 \
    --num_train_epochs 2 \
    ...
    --run_name $RUN_NAME \
    --dataset_cache_dir weights/DeViL_stage2/.cache \
    --lora_enable True \
    --lora_r 256 \
    --lora_alpha 512